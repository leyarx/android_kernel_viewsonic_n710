/*
 * arch/arm/mach-tegra/board-n710-power-ti.c
 *
...
static void n710_ti_get_board_info(struct board_info *bi)
{
	bi->board_id = 0x0245;
	bi->sku = 0x820;
	bi->fab =0xe8;
...
#define TPS6591X_DEV_COMMON_N710		\
	TPS_REG(VDD_2, vdd2, 0),		\
	TPS_REG(VDDCTRL, vddctrl, 0),		\
	TPS_REG(LDO_1, ldo1, 0),		\
	TPS_REG(LDO_2, ldo2, 0),		\
...
static struct i2c_board_info __initdata n710_ti_regulators[] = {
	{
...
int __init n710_ti_regulator_init(void)
{
	...
	n710_ti_get_board_info(&board_info);
	...
	i2c_register_board_info(4, n710_ti_regulators, 1);
...
int __init n710_ti_fixed_regulator_init(void)
{
	struct board_info board_info;
	struct board_info pmu_board_info;
...
subsys_initcall_sync(n710_ti_fixed_regulator_init);

static void n710_ti_board_suspend(int lp_state, enum suspend_stage stg)
{
	if ((lp_state == TEGRA_SUSPEND_LP1) && (stg == TEGRA_SUSPEND_BEFORE_CPU))
		tegra_console_uart_suspend();
}

static void n710_ti_board_resume(int lp_state, enum resume_stage stg)
{
	if ((lp_state == TEGRA_SUSPEND_LP1) && (stg == TEGRA_RESUME_AFTER_CPU))
		tegra_console_uart_resume();
}

static struct tegra_suspend_platform_data n710_ti_suspend_data = {
	.cpu_timer	= 2000,
	.cpu_off_timer	= 200,
	...
	.board_suspend = n710_ti_board_suspend,
	.board_resume = n710_ti_board_resume,
};

int __init n710_ti_suspend_init(void)
{
	struct board_info board_info;
	struct board_info pmu_board_info;
	...
	if ((pmu_board_info.fab == BOARD_FAB_A03) ||
		...
		n710_ti_suspend_data.corereq_high = true;
	...
	*/
	...
	case BOARD_E1256:
	case BOARD_E1257:
		n710_ti_suspend_data.cpu_timer = 5000;
		n710_ti_suspend_data.cpu_off_timer = 5000;
		break;
	case BOARD_E1187:
	case BOARD_E1186:
	...
	tegra_init_suspend(&n710_ti_suspend_data);
	return 0;
}

#ifdef CONFIG_TEGRA_EDP_LIMITS

int __init n710_ti_edp_init(void)
{
