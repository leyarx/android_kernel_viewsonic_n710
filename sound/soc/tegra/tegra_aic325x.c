/*
 * tegra_aic325x.c - Tegra machine ASoC driver for boards using TI 3206 codec.
 *
 * Author: Yaroslav Levandovskiy <leyarx@gmail.com>
 *
...
#else
		.cpu_dai_name = "tegra30-i2s.1", //tegra30-i2s.0
#endif
		.codec_dai_name = "tlv320aic325x-MM_EXT",  //aic325x-asi1
...
/*	[DAI_LINK_BTSCO] = {
	...
	[DAI_LINK_VOICE_CALL] = {
			...
			.codec_name = "aic325x-codec.4-0018",
			.platform_name = "tegra-pcm-audio",
			.cpu_dai_name = "dit-hifi",
			.codec_dai_name = "aic325x-asi2",
...
// TODO: Check this part
	if(machine_is_tegra_enterprise()) {
		tegra_aic325x_dai[DAI_LINK_HIFI].codec_name = "aic325x-codec.0-0018";
		tegra_aic325x_dai[DAI_LINK_VOICE_CALL].codec_name = "aic325x-codec.0-0018";
		tegra_aic325x_dai[DAI_LINK_VOICE_CALL].codec_dai_name = "aic325x-asi1";
	}*/
...
/* Module information */
MODULE_AUTHOR("Yaroslav Levandovskiy <leyarx@gmail.com>");
MODULE_DESCRIPTION("Tegra+AIC3206 machine ASoC driver");
