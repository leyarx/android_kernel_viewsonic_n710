...
#define ___MFD_AIC3256_REGISTERS_H__

#define AIC3256_CODEC_SUPPORT 1
#define AIC3256_PLL_CLKIN_MCLK1		0
// Moved the following registers from tlv320aic325x.h as part of the MFD changes
/* ****************** Page 0 Registers **************************************/
/* Page select register */
#define	AIC3256_PAGE_SELECT		AIC3XXX_MAKE_REG(0,0,0)
/* Software reset register */
#define	AIC3256_RESET				AIC3XXX_MAKE_REG(0,0,1)
/*Clock setting register 1, Multiplexers*/
#define	AIC3256_CLK_REG_1			AIC3XXX_MAKE_REG(0,0,4)
#define AIC3256_PLL_CLKIN_MCLK		0
#define AIC3256_PLL_CLKIN_BCLK		1
#define AIC3256_PLL_CLKIN_GPIO		2
#define AIC3256_PLL_CLKIN_DIN		3
/*Clock setting register 2, PLL*/
#define	AIC3256_CLK_REG_2			AIC3XXX_MAKE_REG(0,0,5)
/*Clock setting register 3, PLL*/
#define	AIC3256_CLK_REG_3			AIC3XXX_MAKE_REG(0,0,6)
/*Clock setting register 4, PLL*/
#define	AIC3256_CLK_REG_4			AIC3XXX_MAKE_REG(0,0,7)
/*Clock setting register 5, PLL*/
#define	AIC3256_CLK_REG_5			AIC3XXX_MAKE_REG(0,0,8)
/*Clock setting register 6, PLL*/
#define	AIC3256_NDAC_CLK_REG_6		        AIC3XXX_MAKE_REG(0,0,11)
/*Clock setting register 7, PLL*/
#define	AIC3256_MDAC_CLK_REG_7		        AIC3XXX_MAKE_REG(0,0,12)
/*DAC OSR setting register1,MSB value*/
#define AIC3256_DAC_OSR_MSB			AIC3XXX_MAKE_REG(0,0,13)
/*DAC OSR setting register 2,LSB value*/
#define AIC3256_DAC_OSR_LSB			AIC3XXX_MAKE_REG(0,0,14)
/*Clock setting register 8, PLL*/
#define	AIC3256_NADC_CLK_REG_8			AIC3XXX_MAKE_REG(0,0,18)
/*Clock setting register 9, PLL*/
#define	AIC3256_MADC_CLK_REG_9			AIC3XXX_MAKE_REG(0,0,19)
/*ADC Oversampling (AOSR) Register*/
#define AIC3256_ADC_OSR_REG			AIC3XXX_MAKE_REG(0,0,20)
/*Clock setting register 9, Multiplexers*/
#define AIC3256_CLK_MUX_REG_9		        AIC3XXX_MAKE_REG(0,0,25)
/*Clock setting register 10, CLOCKOUT M divider value*/
#define AIC3256_CLK_REG_10			AIC3XXX_MAKE_REG(0,0,26)
/*Audio Interface Setting Register 1*/
#define AIC3256_INTERFACE_SET_REG_1	        AIC3XXX_MAKE_REG(0,0,27)
/*Audio Interface Setting Register 2*/
#define AIC3256_INTERFACE_SET_REG_2			AIC3XXX_MAKE_REG(0,0,28)
/*Audio Interface Setting Register 3*/
#define AIC3256_INTERFACE_SET_REG_3			AIC3XXX_MAKE_REG(0,0,29)
/*Clock setting register 11,BCLK N Divider*/
#define AIC3256_CLK_REG_11			AIC3XXX_MAKE_REG(0,0,30)
/*Audio Interface Setting Register 4,Secondary Audio Interface*/
#define AIC3256_AIS_REG_4			AIC3XXX_MAKE_REG(0,0,31)
/*Audio Interface Setting Register 5*/
#define AIC3256_AIS_REG_5			AIC3XXX_MAKE_REG(0,0,32)
/*Audio Interface Setting Register 6*/
#define AIC3256_AIS_REG_6			AIC3XXX_MAKE_REG(0,0,33)	
/*ADC Flag Register */
#define AIC3256_ADC_FLAG			AIC3XXX_MAKE_REG(0,0,36)
/*DAC Flag Register 1*/
#define AIC3256_DAC_FLAG_1			AIC3XXX_MAKE_REG(0,0,37)
/*DAC Flag Register 2*/
#define AIC3256_DAC_FLAG_2			AIC3XXX_MAKE_REG(0,0,38)		
/* Sticky flag for Headset Insertion/ removal */
#define AIC3256_STICKY_FLAG1			AIC3XXX_MAKE_REG(0,0,44)
/* Status flag holds the Headst detection status */
#define AIC3256_STATUS_FLAG1			AIC3XXX_MAKE_REG(0,0,46)

#define AIC3256_ INT1_CTRL			AIC3XXX_MAKE_REG(0,0,48)
...
#define AIC3256_DAC_PRB				AIC3XXX_MAKE_REG(0,0,60)
/*ADC Signal Processing Block*/
#define AIC3256_ADC_PRB				AIC3XXX_MAKE_REG(0,0,61)
/*DAC channel setup register*/
#define AIC3256_DAC_CHN_REG                     AIC3XXX_MAKE_REG(0,0,63)
/*DAC Mute and volume control register*/
#define AIC3256_DAC_MUTE_CTRL_REG	        AIC3XXX_MAKE_REG(0,0,64)
/*Left DAC channel digital volume control*/
#define AIC3256_LDAC_VOL			AIC3XXX_MAKE_REG(0,0,65)
/*Right DAC channel digital volume control*/
#define AIC3256_RDAC_VOL			AIC3XXX_MAKE_REG(0,0,66)

/*Headset Detection Configuration Register*/
#define AIC3256_HEADSET_DETECT                  AIC3XXX_MAKE_REG(0,0,67)

/* DRC control Registers */
#define AIC3256_DRC_CTRL_REG1                   AIC3XXX_MAKE_REG(0,0,68)
#define AIC3256_DRC_CTRL_REG2                   AIC3XXX_MAKE_REG(0,0,69)
#define AIC3256_DRC_CTRL_REG3                   AIC3XXX_MAKE_REG(0,0,70)

/* Beep Generator Control Registers */
#define AIC3256_BEEP_CTRL_REG1                  AIC3XXX_MAKE_REG(0,0,71)
#define AIC3256_BEEP_CTRL_REG2                  AIC3XXX_MAKE_REG(0,0,72)
#define AIC3256_BEEP_CTRL_REG3                  AIC3XXX_MAKE_REG(0,0,73)
#define AIC3256_BEEP_CTRL_REG4                  AIC3XXX_MAKE_REG(0,0,74)
#define AIC3256_BEEP_CTRL_REG5                  AIC3XXX_MAKE_REG(0,0,75)
#define AIC3256_BEEP_CTRL_REG6                  AIC3XXX_MAKE_REG(0,0,76)
#define AIC3256_BEEP_CTRL_REG7                  AIC3XXX_MAKE_REG(0,0,77)
#define AIC3256_BEEP_CTRL_REG8                  AIC3XXX_MAKE_REG(0,0,78)
#define AIC3256_BEEP_CTRL_REG9                  AIC3XXX_MAKE_REG(0,0,79)

/*ADC Register 1*/
#define AIC3256_ADC_CHN_REG			AIC3XXX_MAKE_REG(0,0,81)
/*ADC Fine Gain Adjust*/
#define	AIC3256_ADC_FGA				AIC3XXX_MAKE_REG(0,0,82)
/*Left ADC Channel Volume Control*/
#define AIC3256_LADC_VOL			AIC3XXX_MAKE_REG(0,0,83)
/*Right ADC Channel Volume Control*/
#define AIC3256_RADC_VOL			AIC3XXX_MAKE_REG(0,0,84)

/*Left Channel AGC Control Register 1*/
#define AIC3256_LEFT_AGC_REG1		        AIC3XXX_MAKE_REG(0,0,86)
/*Left Channel AGC Control Register 2*/
#define AIC3256_LEFT_AGC_REG2		        AIC3XXX_MAKE_REG(0,0,87)
/*Left Channel AGC Control Register 3 */
#define AIC3256_LEFT_AGC_REG3		        AIC3XXX_MAKE_REG(0,0,88)
/*Left Channel AGC Control Register 4 */
#define AIC3256_LEFT_AGC_REG4		        AIC3XXX_MAKE_REG(0,0,89)
/*Left Channel AGC Control Register 5 */
#define AIC3256_LEFT_AGC_REG5		        AIC3XXX_MAKE_REG(0,0,90)
/*Left Channel AGC Control Register 6 */
#define AIC3256_LEFT_AGC_REG6		        AIC3XXX_MAKE_REG(0,0,91)
/*Left Channel AGC Control Register 7 */
#define AIC3256_LEFT_AGC_REG7		        AIC3XXX_MAKE_REG(0,0,92)
/*Right Channel AGC Control Register 1*/
#define AIC3256_RIGHT_AGC_REG1		        AIC3XXX_MAKE_REG(0,0,94)
/*Right Channel AGC Control Register 2*/
#define AIC3256_RIGHT_AGC_REG2			AIC3XXX_MAKE_REG(0,0,95)
/*Right Channel AGC Control Register 3 */
#define AIC3256_RIGHT_AGC_REG3			AIC3XXX_MAKE_REG(0,0,96)
/*Right Channel AGC Control Register 4 */
#define AIC3256_RIGHT_AGC_REG4		        AIC3XXX_MAKE_REG(0,0,97)
/*Right Channel AGC Control Register 5 */
#define AIC3256_RIGHT_AGC_REG5		        AIC3XXX_MAKE_REG(0,0,98)
/*Right Channel AGC Control Register 6 */
#define AIC3256_RIGHT_AGC_REG6		        AIC3XXX_MAKE_REG(0,0,99)
/*Right Channel AGC Control Register 7 */
#define AIC3256_RIGHT_AGC_REG7		        AIC3XXX_MAKE_REG(0,0,100)

#endif

/******************** Page 1 Registers **************************************/
/*Power Conguration*/
#define AIC3256_POW_CFG				AIC3XXX_MAKE_REG(0,1,1)
/*LDO Control*/
...
#define AIC3256_OUT_PWR_CTRL			AIC3XXX_MAKE_REG(0,1,9)

/* Full Chip Common Mode register */
#ifdef AIC3256_CODEC_SUPPORT
#define AIC3256_CM_CTRL_REG			AIC3XXX_MAKE_REG(0,1,10)
#endif
/*HPL Routing Selection*/
#define AIC3256_HPL_ROUTE_CTRL		        AIC3XXX_MAKE_REG(0,1,12)
/*HPR Routing Selection*/
#define AIC3256_HPR_ROUTE_CTRL		        AIC3XXX_MAKE_REG(0,1,13)

#ifndef AIC3253_CODEC_SUPPORT
/*LOL Routing Selection*/
#define AIC3256_LOL_ROUTE_CTRL		        AIC3XXX_MAKE_REG(0,1,14)
/*LOR Routing Selection*/
#define AIC3256_LOR_ROUTE_CTRL		        AIC3XXX_MAKE_REG(0,1,15)
#endif

/*HPL Driver Gain*/
#define	AIC3256_HPL_GAIN			AIC3XXX_MAKE_REG(0,1,16)
/*HPR Driver Gain*/
#define	AIC3256_HPR_GAIN			AIC3XXX_MAKE_REG(0,1,17)

#ifndef AIC3253_CODEC_SUPPORT
/*LOL Driver Gain*/
#define	AIC3256_LOL_GAIN			AIC3XXX_MAKE_REG(0,1,18)
/*LOR Driver Gain*/
#define	AIC3256_LOR_GAIN			AIC3XXX_MAKE_REG(0,1,19)
#endif

/*Headphone Driver Startup Control Register*/
#define AIC3256_HPHONE_STARTUP_CTRL	        AIC3XXX_MAKE_REG(0,1,20)
/*IN1L to HPL Volume Control Register */
#define AIC3256_IN1L_HPL_CTRL                   AIC3XXX_MAKE_REG(0,1,22)
/*IN1R to HPR Volume Control Register */
#define AIC3256_IN1R_HPR_CTRL                   AIC3XXX_MAKE_REG(0,1,23)

#ifndef AIC3253_CODEC_SUPPORT
/*MAL Volume Control Register*/
#define AIC3256_MAL_CTRL_REG                    AIC3XXX_MAKE_REG(0,1,24)
/*MAR Volume Control Register*/
#define AIC3256_MAR_CTRL_REG                    AIC3XXX_MAKE_REG(0,1,25)
#endif

/*MICBIAS Configuration Register*/
#define AIC3256_MICBIAS_CTRL		        AIC3XXX_MAKE_REG(0,1,51)

#ifndef AIC3253_CODEC_SUPPORT
/*Left MICPGA Positive Terminal Input Routing Configuration Register*/
#define AIC3256_LMICPGA_PIN_CFG		        AIC3XXX_MAKE_REG(0,1,52)
/*Left MICPGA Negative Terminal Input Routing Configuration Register*/
#define AIC3256_LMICPGA_NIN_CFG		        AIC3XXX_MAKE_REG(0,1,54)
/*Right MICPGA Positive Terminal Input Routing Configuration Register*/
#define AIC3256_RMICPGA_PIN_CFG		        AIC3XXX_MAKE_REG(0,1,55)
/*Right MICPGA Negative Terminal Input Routing Configuration Register*/
#define AIC3256_RMICPGA_NIN_CFG		        AIC3XXX_MAKE_REG(0,1,57)
#endif

/*Floating Input Configuration Register*/
#define AIC3256_INPUT_CFG_REG		        AIC3XXX_MAKE_REG(0,1,58)

#ifndef AIC3253_CODEC_SUPPORT
/*Left MICPGA Volume Control Register*/
#define AIC3256_LMICPGA_VOL_CTRL	        AIC3XXX_MAKE_REG(0,1,59)
/*Right MICPGA Volume Control Register*/
#define AIC3256_RMICPGA_VOL_CTRL	        AIC3XXX_MAKE_REG(0,1,60)
#endif

#define AIC3256_ANALOG_INPUT_CHARGING_CFG	AIC3XXX_MAKE_REG(0,1,71)

#define AIC3256_REF_PWR_UP_CONF_REG		AIC3XXX_MAKE_REG(0,1,123)

#if defined(AIC3256_CODEC_SUPPORT) || defined(AIC3206_CODEC_SUPPORT)
/*charge control register*/
#define AIC3256_CHRG_CTRL_REG                   AIC3XXX_MAKE_REG(0,1,124)
/*headphone driver configuration register*/
#define AIC3256_HP_DRIVER_CONF_REG              AIC3XXX_MAKE_REG(0,1,125)
#endif

#define AIC3256_ADC_DATAPATH_SETUP     	AIC3XXX_MAKE_REG(0,0,81)
#define AIC3256_DAC_DATAPATH_SETUP	AIC3XXX_MAKE_REG(0,0,63)

#define AIC3256_ADC_FLAG		AIC3XXX_MAKE_REG(0,0,36)
#define AIC3256_ADC_POWER_MASK		0x44

#define AIC3256_DAC_FLAG		AIC3XXX_MAKE_REG(0,0,37)
...
#define AIC3256_HP_DETECT               AIC3XXX_MAKE_REG(0,0, 67)
...
/*****************************************************************/
#define AIC3256_ADC_ADAPTIVE_CRAM_REG	AIC3XXX_MAKE_REG(0,8,1)
#define AIC3256_DAC_ADAPTIVE_CRAM_REG	AIC3XXX_MAKE_REG(0,44,1)
...
#define AIC3256_TIME_DELAY              5000
...
#define AIC3256_REF_PWR_UP_MASK			0x7
#define AIC3256_AUTO_REF_PWR_UP			0x0
#define AIC3256_FORCED_REF_PWR_UP		0x5
