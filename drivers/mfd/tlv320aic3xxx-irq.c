...
static struct aic3xxx_irq_data aic3xxx_irqs[] = {
	 ...
	 },
	{
	 ...
	 .status = AIC3XXX_LEFT_OUTPUT_DRIVER_OVERCURRENT_INT | AIC3XXX_RIGHT_OUTPUT_DRIVER_OVERCURRENT_INT,
	 },
	{
	.mask = AIC3XXX_OVERFLOW_M,
	.status = AIC3XXX_LEFT_DAC_OVERFLOW_INT | AIC3XXX_RIGHT_DAC_OVERFLOW_INT | AIC3XXX_LEFT_ADC_OVERFLOW_INT | AIC3XXX_RIGHT_ADC_OVERFLOW_INT,
	},
...
{
        struct aic3xxx *aic3xxx = irq_data_get_irq_chip_data(data);
	struct aic3xxx_irq_data *irq_data = irq_to_aic3xxx_irq(aic3xxx, data->irq);
